...
object Quinoa_2_Linux_Matrix : Template({
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ${stepPrefix}
                if [ %smp% ]; then ./charmrun +p 6 "--bind-to none -oversubscribe" Main/unittest -v -q +ppn 3; else mpirun -n 2 "--bind-to none -oversubscribe" Main/unittest -v -q; fi && ctest -j8 --output-on-failure -LE extreme
            """.trimIndent()
        }
    }
