...
object Quinoa_2_Linux_Matrix : Template({
    ...
    val stepPrefix = """
      ...
      module load pugixml pegtl pstreams boost-1.65.1-gcc-4.8.5-s7d4zmv gmsh-3.0.1-gcc-4.8.5-xqrg5fi random123 tut cartesian_product numdiff libc++ backward-cpp highwayhash
