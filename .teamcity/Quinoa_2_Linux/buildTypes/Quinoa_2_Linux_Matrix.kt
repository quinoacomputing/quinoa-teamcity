...
object Quinoa_2_Linux_Matrix : Template({
    ...
    val stepPrefix = """
      ...
      [ %compiler% == intel ] && module load intel/2018 openmpi/2.0.2/intel/2018 hdf5/intel netcdf/intel hypre/intel root/intel
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ...
                cmake -DCMAKE_CXX_COMPILER=mpicxx -DCMAKE_C_COMPILER=mpicc -DCMAKE_BUILD_TYPE=%buildtype% -DSTDLIBCPP=%stdlibcpp% -DCMAKE_DISABLE_FIND_PACKAGE_RNGSSE2=!%rngsse2% -DCMAKE_DISABLE_FIND_PACKAGE_TestU01=!%testu01% -DCMAKE_CXX_FLAGS=-Werror -GNinja ../src && ninja -j8
            """.trimIndent()
        }
        script {
            name = "Run tests"
            ...
            scriptContent = """
                ${stepPrefix}
                ../script/run_tests.sh 8 mpirun -n -oversubscribe
            """.trimIndent()
        }
    }
