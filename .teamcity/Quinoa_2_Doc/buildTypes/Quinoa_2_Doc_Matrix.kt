...
object Quinoa_2_Doc_Matrix : Template({
    ...
    val stepPrefix = """
        ...
        module load gcc-9.1.0-gcc-8.2.0-757ly4p openmpi-3.1.3-gcc-9.1-3h7qsmb hdf5-1.10.1-gcc-4.8.5-rosmsxt netcdf-4.4.1.1-gcc-4.8.5-4rodz7d root/gnu-9 mkl/2018 rngsse2 testu01 charm/gnu-9-libstdc++ h5part/gnu trilinos/gnu-9-libstdc++/mkl pugixml pegtl pstreams boost-1.65.1-gcc-4.8.5-s7d4zmv gmsh-4.0.0-gcc-8.2.0-qcgnz7f random123 tut numdiff highwayhash omega_h/gnu-9-libstdc++ backward-cpp brigand doxygen mcss python-3.6.5-gcc-4.8.5-3gahby7 py-jinja2-2.9.6-gcc-4.8.5-c3xwcj5 py-pygments-2.2.0-gcc-4.8.5-alkmyw7 py-markupsafe-1.0-gcc-4.8.5-5qh4ssa texlive-live-gcc-4.8.5-ojsyovg
        module list
